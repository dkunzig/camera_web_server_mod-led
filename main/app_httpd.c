...
static esp_err_t led_on(httpd_req_t *req)
{
	...
	static esp_err_t led_off(httpd_req_t *req)
	{
...
static esp_err_t cmd_handler(httpd_req_t *req){
	...
	else if(!strcmp(variable, "duty_cycle")) duty_cycle = val;
